...
/-!
# `Denote/Clink/Controls.lean` — derivations in the certified judgment, and the gate

A separate module from `Denote/Clink/Registry.lean` for a mundane reason worth recording: the
