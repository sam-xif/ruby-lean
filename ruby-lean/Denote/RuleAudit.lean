import Denote.Safety

/-!
# `Denote/RuleAudit.lean` — which rules the safety proof **actually** uses

`Denote/Safety.lean` §4 answers "which registered rules does the end-to-end safety
