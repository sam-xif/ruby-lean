import Denote.Ty.Join
import Denote.Sem.Core.State

/-!
# `Denote/Sem/Core/JoinState.lean` — the branch join at the *state* level

`Denote/Ty/Join.lean` joins **types**: `denM_joinT_left`/`_right` say a value of either branch's
