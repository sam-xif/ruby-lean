...
/-!
# `Denote/Sem/Core/Transport.lean` — the two lemmas every leaf rung needs
...
future-quantified arrow (`Denote/Ty/Den.lean` §The arrow arm point 5) compatible with the rest
...
The eleven-line proof this replaces is recorded in `../../notes/ratchet/implementation-notes.md`; the point
