...
import Ratchet.Controls.MethodControls
import Ratchet.Controls.InitCheckControls
...
now returns the derivation (`Ratchet/Check/Check.lean` §3), so "sound" is not the question these
