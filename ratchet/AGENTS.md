...
The typed/safe gap is closed: **32 accepted corpus rungs have end-to-end `StuckFree`
proofs**, **safety reach 17**, **16 registered rules** (12 expressions + 4 list companions),
**0 owed**, **0 exempt**. Checker reach is 21; rung 018 is correctly rejected,
...
and nine `DPrim` rows. [`Denote/Typed/Clink.lean`](Denote/Typed/Clink.lean) derives each
...
| `Denote/Typed/Derivations.lean`, `CorpusSafety.lean` | Constructor-wise builders and 32 concrete safety proofs |
